...
export class ChecklistDatabase {
  ...
  insertItem(parent: TodoItemNode, name: string) {
    console.log("Inside insertItem",parent,name);
    if (parent.children) {
  ...
  updateItem(node: TodoItemNode, name: string) {
    console.log("Inside update",node,name);
    node.item = name;
    this.dataChange.next(this.data);
...
export class AttributeComponent implements OnInit {
  ...
  constructor(private _database: ChecklistDatabase,private fb: FormBuilder) {
  ...
  addNewItem(node: TodoItemFlatNode) {
    console.log("inside addNewItem",node);
  ...
  saveNode(node: TodoItemFlatNode, itemValue: string) {
    console.log("inside save node",node);
  ...
  // saveToTreeData(value){
  //   console.log("inside saveToTreeData method");
  //   console.log(value);
